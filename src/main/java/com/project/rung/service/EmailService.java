 ...
 *   MAIL_FROM        From address (default noreply@rung.app)
...
public class EmailService {
    ...
    @Value("${app.email.from:noreply@rung.app}")
    private String fromAddress;

    @Value("${app.reset-base-url:https://rung.app/reset}")
    private String resetBaseUrl;

    @Value("${app.email.app-url:https://rung.app}")
    ...
    public void sendWelcome(String toEmail, String displayName) {
        ...
        sendHtml(toEmail, "Welcome to Rung, " + displayName + "!", html);
    }
    ...
    public void sendEmailVerification(String toEmail, String code, long ttlMinutes) {
        ...
        sendHtml(toEmail, "Verify your Rung email", html);
    }
    ...
    public void sendPasswordReset(String toEmail, String displayName, String token) {
        ...
        String body = """
                ...
                We received a request to reset the password for your Rung account.
        ...
        sendPlain(toEmail, "Reset your Rung password", body);
    }
    ...
    public void sendAccountDeleted(String toEmail, String displayName,
        ...
        sendHtml(toEmail, "Goodbye from Rung — and some parting wisdom", html);
    }
