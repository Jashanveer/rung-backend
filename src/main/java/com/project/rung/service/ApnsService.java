 ...
 *   apns.bundle-id-macos  e.g. jashanveer.Rung
 *   apns.bundle-id-ios    e.g. jashanveer.Rung-iOS
...
public class ApnsService {
    ...
    @Value("${apns.bundle-id-macos:jashanveer.Rung}")
    private String bundleIdMacos;

    @Value("${apns.bundle-id-ios:jashanveer.Rung-iOS}")
